    ...
    <AppShell>
      <header className="topbar">
        <div>
          ...
          <h1>Live hosted product pages</h1>
          <p className="muted">Copy links for your store, ads, emails, or QR codes.</p>
        </div>
            ...
            <div>
              ...
              <div className="assetGrid">
                ...
                <span className={product.hostedPage?.status === "published" ? "badge success" : "badge neutral"}>
                  {product.hostedPage?.status === "published" ? "Verified and live" : "Not published"}
                </span>
              </div>
            </div>
            <div className="rightStack">
              ...
              {product.hostedPage?.status === "published" ? (
                <>
                  ...
                  <div className="assetGrid">
                    <Link className="button secondary" href={product.hostedPage.publicUrl}>
                      Preview
                    </Link>
                ...
                <span className="muted">Available after approval and publishing.</span>
              )}
